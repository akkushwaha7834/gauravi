...
$route['services/(:any)'] = 'website/services_details/$1';

$route['login'] = 'website/login';
$route['about'] = 'website/about';
$route['contact'] = 'website/contact';
$route['contact_submit_data'] = 'website/contact_submit_data';
$route['consultation'] = 'website/consultation';
$route['consultation_submit_data'] = 'website/consultation_submit_data';
